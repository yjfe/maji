    ...
    <ComponentFormHeadTabs>
      <template slot="base">
        <FoldWraper label="基础信息" :level="1">
          ...
          <el-form-item label="图形方向：" prop="yName">
        ...
        <FoldWraper label="坐标轴" :level="1">
          <el-form-item label="横坐标名称：" prop="xName">
            <el-input v-model="item.xName" />
          </el-form-item>
          <el-form-item label="横坐标字段名：" prop="xKey">
            <el-input v-model="item.xKey" />
          </el-form-item>
          <el-form-item label="显示缩略轴：" prop="hasDataZoom">
            <el-radio-group v-model="item.hasDataZoom" >
              <el-radio :label="2">智能适配</el-radio>
              <el-radio :label="1">显示</el-radio>
              <el-radio :label="0">不显示</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="纵坐标名称：" prop="yName">
...
export default {
  ...
  methods: {
    handleAdd() {
      ...
      const colorIndex = parseInt(Math.random() * 7, 10)
      this.item.yOptions.push({ 
        ...{
          ...
          openType: 0,
          chartType: 'line', // 数据图形
          color: baseData.predefineColors[colorIndex],
